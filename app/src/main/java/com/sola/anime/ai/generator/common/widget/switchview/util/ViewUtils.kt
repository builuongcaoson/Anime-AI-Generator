package com.sola.anime.ai.generator.common.widget.switchview.util
...
//    }
    ...
    fun addShadow(contentView: View) {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
            contentView.outlineAmbientShadowColor = contentView.context.resolveAttrColor(android.R.attr.colorAccent)
            contentView.outlineSpotShadowColor = contentView.context.resolveAttrColor(android.R.attr.colorAccent)
        }
    }
