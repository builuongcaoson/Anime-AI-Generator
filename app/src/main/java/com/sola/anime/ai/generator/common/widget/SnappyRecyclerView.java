...
//        addFadeOut();
        ...
        addOnScrollListener(new OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                for(int i = firstView; i <= lastView; i++) {
                    ...
                    Log.d(TAG, "Distance from center of view: " + distanceFromCenter);

                    float percentFromCenter = distanceFromCenter / centerScreen;
                    Log.d(TAG, "Distance from center of view (%): " + percentFromCenter);
    ...
    private void setScale(float percentFromCenter, View currentView) {
        float scaleFactor = 1.0f + (0.2f * (1.0f - percentFromCenter));
