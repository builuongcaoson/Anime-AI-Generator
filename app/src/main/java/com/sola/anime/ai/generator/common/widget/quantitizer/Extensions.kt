...
fun LsTextView.textAnimSwing(translation: String, startPosition: Float, endPosition: Float, text: String , duration: Long){
    //enter
...
fun LsTextView.textAnimSlideInLTR(translation: String, startPosition: Float, endPosition: Float, text: String, duration: Long){
    //enter
    enterAnimationSwing(translation, endPosition, startPosition, duration) // first play enter animation. End and Start positions are inverted for proper animation
    //exit
    Handler(Looper.getMainLooper()).postDelayed(
...
fun LsTextView.textAnimSlideInRTL(translation: String, startPosition: Float, endPosition: Float, text: String , duration: Long){
    //enter
    enterAnimationSwing(translation, endPosition, startPosition, duration) // first play enter animation. End and Start positions are inverted for proper animation
    //exit
    Handler(Looper.getMainLooper()).postDelayed(
...
fun LsTextView.textAnimFallIn(translation: String, startPosition: Float, endPosition: Float, text: String , duration: Long){
    //enter
    enterAnimationSwing(translation, endPosition, startPosition, duration) // first play enter animation. End and Start positions are inverted for proper animation
    //exit
    Handler(Looper.getMainLooper()).postDelayed(
