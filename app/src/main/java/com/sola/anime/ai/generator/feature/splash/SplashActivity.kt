...
//                        BuildConfig.DEBUG -> 5L
                    ...
                    configApp.keyDezgo = tryOrNull { config.getString("key_5").takeIf { it.isNotEmpty() } } ?: configApp.keyDezgo
                    configApp.keyDezgoPremium = tryOrNull { config.getString("key_premium_5").takeIf { it.isNotEmpty() } } ?: configApp.keyDezgoPremium
