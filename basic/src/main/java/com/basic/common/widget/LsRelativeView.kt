...
@AndroidEntryPoint
class LsRelativeView @JvmOverloads constructor(
    ...
    init {
        ...
        context.obtainStyledAttributes(attrs, R.styleable.LsRelativeView).run {
            backgroundTintAttr = getInt(R.styleable.LsRelativeView_bgColorTint, ColorManager.COLOR_NONE)
            recycle()
        }
