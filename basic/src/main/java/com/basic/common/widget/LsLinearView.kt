...
@AndroidEntryPoint
class LsLinearView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : LinearLayout(context, attrs), UIChangedListener {
    ...
    init {
        ...
        context.obtainStyledAttributes(attrs, R.styleable.LsLinearView).run {
            backgroundTintAttr = getInt(R.styleable.LsLinearView_bgColorTint, ColorManager.COLOR_NONE)
            recycle()
        }
