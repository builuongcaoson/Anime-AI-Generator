...
@AndroidEntryPoint
class LsView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null
) : View(context, attrs), UIChangedListener {
    ...
    init {
        ...
        context.obtainStyledAttributes(attrs, R.styleable.LsView).run {
            backgroundTintAttr = getInt(R.styleable.LsView_bgColorTint, ColorManager.COLOR_NONE)
            recycle()
        }
