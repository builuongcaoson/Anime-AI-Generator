...
public class LsScrollPopup {
    ...
    @LsScroller.PopupTextVerticalAlignmentMode private int mTextVerticalAlignmentMode;
    @LsScroller.PopupPosition private int mPosition;

    LsScrollPopup(Resources resources, LsRecyclerView recyclerView) {
    ...
    public void setPopupTextVerticalAlignmentMode(@LsScroller.PopupTextVerticalAlignmentMode int mode) {
        mTextVerticalAlignmentMode = mode;
    }

    @LsScroller.PopupTextVerticalAlignmentMode
    public int getPopupTextVerticalAlignmentMode() {
        return mTextVerticalAlignmentMode;
    }

    public void setPopupPosition(@LsScroller.PopupPosition int position) {
        mPosition = position;
    }

    @LsScroller.PopupPosition
    public int getPopupPosition() {
        return mPosition;
    }

    private float[] createRadii() {
        if (mPosition == LsScroller.PopupPosition.CENTER) {
    ...
    public void draw(Canvas canvas) {
        if (isVisible()) {
            ...
            if (mTextVerticalAlignmentMode == LsScroller.PopupTextVerticalAlignmentMode.FONT_METRICS) {
     ...
     */
    public Rect updateFastScrollerBounds(LsRecyclerView recyclerView, int thumbOffsetY) {
